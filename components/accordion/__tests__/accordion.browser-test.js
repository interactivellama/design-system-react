define(['react', 'chai', 'chai-enzyme', 'enzyme', '../../../tests/enzyme-helpers', '../../accordion', '../../icon-settings', '../../accordion/panel', '../../menu-dropdown'], function (_react, _chai, _chaiEnzyme, _enzyme, _enzymeHelpers, _accordion, _iconSettings, _panel, _menuDropdown) {
	'use strict';
