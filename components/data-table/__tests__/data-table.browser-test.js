define(['react', 'react-dom', 'react-addons-test-utils', 'chai', '../../data-table', '../../data-table/column', '../../data-table/row-actions', '../../data-table/highlight-cell', '../../icon-settings'], function (_react, _reactDom, _reactAddonsTestUtils, _chai, _dataTable, _column, _rowActions, _highlightCell, _iconSettings) {
	'use strict';
	...
	describe('DataTable: ', function () {
		...
		describe('Structure', function () {
			beforeEach(renderTable(_react2.default.createElement(
				_dataTable2.default,
				defaultProps,
				columns.map(function (columnProps) {
					return _react2.default.createElement(_column2.default, _extends({}, columnProps, { key: columnProps.property }));
				})
			)));
			...
			it('has checkboxes only when selectRows is true', function () {
				...
				renderTable(_react2.default.createElement(
					_dataTable2.default,
				...
				renderTable(_react2.default.createElement(
					...
					columns.map(function (columnProps) {
						return _react2.default.createElement(
							_column2.default,
							_extends({}, columnProps, { key: columnProps.property }),
