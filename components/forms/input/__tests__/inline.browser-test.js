define(['react', 'react-dom', 'react-addons-test-utils', 'chai', '../../../forms/input/inline', '../../../icon-settings'], function (_react, _reactDom, _reactAddonsTestUtils, _chai, _inline, _iconSettings) {
	'use strict';
	...
	describe('Inline Edit: ', function () {
		...
		describe('Structure', function () {
			beforeEach(renderInlineEdit(_react2.default.createElement(_inline2.default, { id: 'inline-edit-standard', value: sampleValue })));
