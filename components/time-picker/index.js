define(['exports', 'react', 'create-react-class', 'prop-types', 'lodash.isdate', '../icon/input-icon', '../menu-dropdown', './private/dropdown-trigger', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _lodash, _inputIcon, _menuDropdown, _dropdownTrigger, _constants) {
	'use strict';
