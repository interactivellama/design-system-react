...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* eslint-disable react/no-string-refs */
			...
			var TestTimepicker = (0, _react.createFactory)((0, _createReactClass2.default)({
				...
				render: function render() {
					return _react2.default.createElement(
						...
						_react2.default.createElement(_timePicker2.default, _extends({ ref: 'timePicker' }, defaultProps))
					);
				}
			}));
