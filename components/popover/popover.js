define(['exports', 'react', 'create-react-class', 'prop-types', 'lodash.assign', 'classnames', 'lodash.isboolean', 'lodash.isfunction', './check-props', 'shortid', '../button', '../utilities/dialog', '../../utilities/dialog-helpers', '../../utilities/keyboard-navigable-dialog', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _lodash, _classnames, _lodash3, _lodash5, _checkProps, _shortid, _button, _dialog, _dialogHelpers, _keyboardNavigableDialog, _keyCode, _constants) {
	'use strict';
