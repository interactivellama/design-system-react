define(['react', 'enzyme', 'chai', 'chai-enzyme', '../../icon-settings', '../../page-header', '../../button-stateful', '../../button-group', '../../button', '../../menu-dropdown'], function (_react, _enzyme, _chai, _chaiEnzyme, _iconSettings, _pageHeader, _buttonStateful, _buttonGroup, _button, _menuDropdown) {
	'use strict';
	...
	var recordHomeContentRight = _react2.default.createElement(
		'div',
		null,
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_menuDropdown2.default, {
				...
				openOn: 'click',
				align: 'right',
				options: [{ label: 'Disable', value: 'A0' }, { label: 'Promote', value: 'C0' }]
			})
		)
	);
	...
	var recordHomeDetails = [{
		...
		flavor: '1-of-4',
		truncate: true
	}, { label: 'Last Modified', content: 'August 31, 2016 2:01PM PST' }, { label: 'Status', content: 'Status of thing you wanna know' }];
