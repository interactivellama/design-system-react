define(['react', 'create-react-class', 'prop-types', 'chai', 'chai-enzyme', 'object.entries', '../../../tests/enzyme-helpers', '../../../utilities/sample-data/navigation', '../../navigation'], function (_react, _createReactClass, _propTypes, _chai, _chaiEnzyme, _object, _enzymeHelpers, _navigation, _navigation2) {
	'use strict';
