define(['react', 'react-dom', 'lodash.assign', 'react-addons-test-utils', 'chai', '../../menu-picklist', '../../icon-settings'], function (_react, _reactDom, _lodash, _reactAddonsTestUtils, _chai, _menuPicklist, _iconSettings) {
	'use strict';
	...
	describe('SLDSMenuPicklist: ', function () {
		...
		describe('with click handler', function () {
			...
			beforeEach(function () {
				clicked = false;
				cmp = getPicklist({ onClick: function onClick() {
						clicked = true;
					} });
				btn = findRenderedDOMComponentWithClass(cmp, 'slds-button');
			});
		...
		describe('expanded with onSelect', function () {
			...
			beforeEach(function () {
				selected = false;
				cmp = getPicklist({ onSelect: function onSelect(i) {
						selected = i;
					} });
				btn = findRenderedDOMComponentWithClass(cmp, 'slds-button');
				Simulate.click(btn, {});
		...
		describe('disabled', function () {
			...
			beforeEach(function () {
				clicked = false;
				cmp = getPicklist({ disabled: true, onClick: function onClick() {
						clicked = true;
					} });
				btn = findRenderedDOMComponentWithClass(cmp, 'slds-button');
			});
