define(['exports', 'react', 'create-react-class', 'prop-types', './check-props', 'classnames', 'shortid', '../utilities/dialog', '../icon', '../utilities/menu-list', '../utilities/menu-list/item-label', '../utilities/pill', 'airbnb-prop-types', '../../utilities/keyboard-navigable-menu', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _checkProps, _classnames, _shortid, _dialog, _icon, _menuList, _itemLabel, _pill, _airbnbPropTypes, _keyboardNavigableMenu, _event, _keyCode, _constants) {
	'use strict';
						...
						events: {
							onRequestRemove: function onRequestRemove(event, data) {
								...
								if (_this2.props.onPillRemove) {
									...
									_this2.props.onPillRemove(option, { option: option, optionIndex: index });
								}
							}
						},
						labels: {
