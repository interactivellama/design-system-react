define(['react', 'enzyme', 'chai', 'lodash.assign', 'react-addons-test-utils', '../../icon-settings', '../../app-launcher/tile', '../../app-launcher/section'], function (_react, _enzyme, _chai, _lodash, _reactAddonsTestUtils, _iconSettings, _tile, _section) {
	'use strict';
	...
	describe('SLDS APP LAUNCHER SECTION *******************************************', function () {
		...
		var defaultChildren = [_react2.default.createElement(_tile2.default, { key: 'asdf', title: 'Marketing Cloud' }), _react2.default.createElement(_tile2.default, { key: 'qwer', title: 'Support Cloud' })];
		...
		function mountSection(props) {
			...
			handles.section = (0, _enzyme.mount)(_react2.default.createElement(
		...
		describe('App Launcher Section (small)', function () {
			beforeEach(function () {
				mountSection({}, _react2.default.createElement(_tile2.default, { size: 'small', title: 'Marketing Clout' }));
			});
