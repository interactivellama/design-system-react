define(['react', 'react-dom', 'react-modal', 'chai', 'enzyme', 'lodash.assign', 'react-addons-test-utils', '../../icon-settings', '../../app-launcher', '../../app-launcher/tile', '../../app-launcher/section', '../../forms/input/search', '../../button'], function (_react, _reactDom, _reactModal, _chai, _enzyme, _lodash, _reactAddonsTestUtils, _iconSettings, _appLauncher, _tile, _section, _search, _button) {
	'use strict';
	...
	describe('SLDS APP LAUNCHER *******************************************', function () {
		...
		var createAppLauncher = function createAppLauncher(props) {
			return _react2.default.createElement(_appLauncher2.default, (0, _lodash2.default)({}, defaultAppLauncherProps, props), _react2.default.createElement(
				_section2.default,
				{ title: 'All Items' },
				_react2.default.createElement(_tile2.default, { title: 'Marketing Cloud' }),
				_react2.default.createElement(_tile2.default, { title: 'Support Cloud' })
			));
		};

		function mountAppLauncher(props) {
			handles.appLauncher = (0, _enzyme.mount)(_react2.default.createElement(
    ...
    */
		...
		describe('App Launcher', function () {
			...
			beforeEach(function () {
				...
				mountAppLauncher({
					...
					onClose: onClose,
					search: _react2.default.createElement(_search2.default, { assistiveText: 'Find an app' }),
					title: 'App Launcher!'
				});
			});
			...
			it('app launcher title can be set', function () {
				(0, _chai.expect)(handles.modal.contains(_react2.default.createElement(
					'h2',
		...
		describe('App Launcher Icon', function () {
			...
			it('renders all App Launcher dots', function () {
				(0, _chai.expect)(handles.appLauncherIcon.find('.slds-icon-waffle').containsAllMatchingElements([_react2.default.createElement('span', { className: 'slds-r1' }), _react2.default.createElement('span', { className: 'slds-r2' }), _react2.default.createElement('span', { className: 'slds-r3' }), _react2.default.createElement('span', { className: 'slds-r4' }), _react2.default.createElement('span', { className: 'slds-r5' }), _react2.default.createElement('span', { className: 'slds-r6' }), _react2.default.createElement('span', { className: 'slds-r7' }), _react2.default.createElement('span', { className: 'slds-r8' }), _react2.default.createElement('span', { className: 'slds-r9' })])).to.equal(true);
			});
