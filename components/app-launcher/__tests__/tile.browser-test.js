define(['react', 'enzyme', 'chai', 'lodash.assign', 'react-addons-test-utils', '../../icon-settings', '../../app-launcher/tile', '../../icon'], function (_react, _enzyme, _chai, _lodash, _reactAddonsTestUtils, _iconSettings, _tile, _icon) {
	'use strict';
	...
	describe('SLDS APP LAUNCHER TILE *******************************************', function () {
		...
		function mountTile(props) {
			...
			handles.tile = (0, _enzyme.mount)(_react2.default.createElement(
		...
		describe('App Launcher Tile (icon node)', function () {
			var iconNode = _react2.default.createElement(_icon2.default, { name: 'campaign', category: 'standard', size: 'large' });
