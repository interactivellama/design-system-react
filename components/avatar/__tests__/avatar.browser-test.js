define(['react', 'enzyme', 'chai', 'chai-enzyme', '../../../tests/enzyme-helpers', '../../avatar', '../../icon-settings'], function (_react, _enzyme, _chai, _chaiEnzyme, _enzymeHelpers, _avatar, _iconSettings) {
	'use strict';
	...
	_chai2.default.use((0, _chaiEnzyme2.default)()); /* eslint-disable react/no-render-return-value */
	...
	describe('SLDSAvatar: ', function () {
		...
		describe('Default Structure', function () {
			...
			it('avatar renders with image', function () {
				...
				wrapper = (0, _enzyme.mount)(_react2.default.createElement(_avatar2.default, { imgSrc: expectedSrc }), { attachTo: mountNode });
			...
			it('renders proper icon size class', function () {
				wrapper = (0, _enzyme.mount)(_react2.default.createElement(
					...
					_react2.default.createElement(_avatar2.default, { size: 'large' })
				), { attachTo: mountNode });
			...
			describe('variant is a user', function () {
				beforeEach(function () {
					wrapper = (0, _enzyme.mount)(_react2.default.createElement(
						_iconSettings2.default,
						{ iconPath: '/assets/icons' },
						_react2.default.createElement(_avatar2.default, { variant: 'user' })
					), { attachTo: mountNode });
				});
			...
			describe('variant is an entity', function () {
				beforeEach(function () {
					wrapper = (0, _enzyme.mount)(_react2.default.createElement(
						_iconSettings2.default,
						{ iconPath: '/assets/icons' },
						_react2.default.createElement(_avatar2.default, { variant: 'entity' })
					), { attachTo: mountNode });
				});
		...
		describe('Initials avatar fallback check', function () {
			...
			it('renders "iniitals prop" initials if they are passed in directly', function () {
				var avatar = (0, _enzyme.mount)(_react2.default.createElement(
					_iconSettings2.default,
					{ iconPath: '/assets/icons' },
					_react2.default.createElement(_avatar2.default, { initials: 'AW' })
				), { attachTo: mountNode });
			...
			it('renders fallback initials abbr node if initials or label prop exists', function () {
				var avatar = (0, _enzyme.mount)(_react2.default.createElement(
					_iconSettings2.default,
					{ iconPath: '/assets/icons' },
					_react2.default.createElement(_avatar2.default, { label: 'test' })
				), { attachTo: mountNode });
				var abbr = !!avatar.find('abbr');
			...
			it('calls buildInitials in abbr node if no initials prop', function () {
				var avatar = (0, _enzyme.mount)(_react2.default.createElement(
					_iconSettings2.default,
					{ iconPath: '/assets/icons' },
					_react2.default.createElement(_avatar2.default, { label: 'Jane Doe' })
				), { attachTo: mountNode });
				var abbr = avatar.find('abbr');
			...
			it('renders first two letters of one word if label is one word', function () {
				var avatar = (0, _enzyme.mount)(_react2.default.createElement(
					_iconSettings2.default,
					{ iconPath: '/assets/icons' },
					_react2.default.createElement(_avatar2.default, { label: 'Acme' })
				), { attachTo: mountNode });
				var abbr = avatar.find('abbr');
			...
			it('renders first letters of each word if label is two words', function () {
				var avatar = (0, _enzyme.mount)(_react2.default.createElement(
					_iconSettings2.default,
					{ iconPath: '/assets/icons' },
					_react2.default.createElement(_avatar2.default, { label: 'Acme Communications' })
				), { attachTo: mountNode });
				var abbr = avatar.find('abbr');
				(0, _chai.expect)(abbr.node.textContent).to.equal('AC');
			});
			...
			it('renders first letters of first and last word if label is more than two words', function () {
				var avatar = (0, _enzyme.mount)(_react2.default.createElement(
					_iconSettings2.default,
					{ iconPath: '/assets/icons' },
					_react2.default.createElement(_avatar2.default, { label: 'Acme Communications Inc.' })
				), { attachTo: mountNode });
				var abbr = avatar.find('abbr');
