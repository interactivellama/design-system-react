define(['react', 'prop-types', 'chai', 'chai-enzyme', 'enzyme', 'airbnb-prop-types', '../../../tests/enzyme-helpers', '../../radio-group', '../../radio-group/radio'], function (_react, _propTypes, _chai, _chaiEnzyme, _enzyme, _airbnbPropTypes, _enzymeHelpers, _radioGroup, _radio) {
	'use strict';
