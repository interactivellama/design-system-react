define(['react', 'create-react-class', 'prop-types', 'chai', 'chai-enzyme', 'enzyme', '../../icon-settings', '../../../tests/enzyme-helpers', '../../date-picker', '../../forms/input', '../../../utilities/key-code'], function (_react, _createReactClass, _propTypes, _chai, _chaiEnzyme, _enzyme, _iconSettings, _enzymeHelpers, _datePicker, _input, _keyCode) {
	'use strict';
  ...
  */
    ...
    */
		...
		describe('Optional props', function () {
			...
			var optionalProps = {
				children: _react2.default.createElement(_input2.default, { placeholder: customPlaceholder, value: '' })
			};
			...
			it('has custom input with custom placeholder', function () {
				wrapper = (0, _enzyme.mount)(_react2.default.createElement(DemoComponent, optionalProps), { attachTo: mountNode });
			...
			describe('Esc when menu is open', function () {
				...
				it('opens on trigger click, closes on ESC', function (done) {
					wrapper = (0, _enzyme.mount)(_react2.default.createElement(DemoComponent, {
						...
						onOpen: function onOpen() {
							var firstDayOfMonth = wrapper.find('.datepicker__month [aria-disabled=false]').first();
							firstDayOfMonth.simulate('keyDown', { key: 'Esc', keyCode: _keyCode2.default.ESCAPE, which: _keyCode2.default.ESCAPE });
						}
					}), { attachTo: mountNode });
				...
				it('navigates to next week', function (done) {
					...
					selectedDay.simulate('keyDown', { key: 'Down', keyCode: _keyCode2.default.DOWN, which: _keyCode2.default.DOWN });
				});
				...
				it('navigates to next day', function (done) {
					...
					var selectedDay = wrapper.find('.datepicker__month [aria-selected=true]');
					selectedDay.simulate('keyDown', { key: 'Right', keyCode: _keyCode2.default.RIGHT, which: _keyCode2.default.RIGHT });
				});
				...
				it('navigates to previous week (that is of a previous month)', function (done) {
					...
					var selectedDay = wrapper.find('.datepicker__month [aria-selected=true]');
					selectedDay.simulate('keyDown', { key: 'Up', keyCode: _keyCode2.default.UP, which: _keyCode2.default.UP });
				});
				...
				it('navigates to previous day', function (done) {
					...
					var selectedDay = wrapper.find('.datepicker__month [aria-selected=true]');
					selectedDay.simulate('keyDown', { key: 'Left', keyCode: _keyCode2.default.LEFT, which: _keyCode2.default.LEFT });
				});
				...
				it('calendar blur, focus on previous month button', function (done) {
					...
					var selectedDay = wrapper.find('.datepicker__month [aria-selected=true]');
					selectedDay.simulate('keyDown', { key: 'Tab', keyCode: _keyCode2.default.TAB, which: _keyCode2.default.TAB });
				});
				...
				it('calendar blur, focus on today', function (done) {
					...
					var selectedDay = wrapper.find('.datepicker__month [aria-selected=true]');
					selectedDay.simulate('keyDown', { key: 'Tab', keyCode: _keyCode2.default.TAB, shiftKey: true, which: _keyCode2.default.TAB });
				});
			});
		});
