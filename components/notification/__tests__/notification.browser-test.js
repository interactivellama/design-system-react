define(['react', 'react-dom', 'lodash.assign', 'react-addons-test-utils', 'chai', '../../notification', '../../icon-settings'], function (_react, _reactDom, _lodash, _reactAddonsTestUtils, _chai, _notification, _iconSettings) {
	'use strict';
	...
	describe('SLDSNotification: ', function () {
		...
		describe('component renders', function () {
			it('notification renders', function () {
				var notification = generateNotification(_react2.default.createElement(_notification2.default, { variant: 'toast', theme: 'success', isOpen: true }));
		...
		describe('component basic props render', function () {
			it('renders variant', function () {
				var notification = generateNotification(_react2.default.createElement(_notification2.default, { variant: 'toast', theme: 'success', icon: 'notification', isOpen: true, texture: true, animated: true }));
			...
			it('renders theme', function () {
				var notification = generateNotification(_react2.default.createElement(_notification2.default, { variant: 'toast', theme: 'error', isOpen: true }));
				var alert = notification.getElementsByTagName('div')[0];
				(0, _chai.expect)(alert.className).to.include('slds-theme--error');
			});

			it('renders icon', function (done) {
				var notification = generateNotification(_react2.default.createElement(_notification2.default, { variant: 'alert', theme: 'success', iconName: 'notification', isOpen: true, texture: true, content: 'hi' }));
				setTimeout(function () {
		...
		describe('dismiss notification click', function () {
			it('button onClick invokes method from props', function (done) {
				...
				var notification = generateNotification(_react2.default.createElement(_notification2.default, { variant: 'toast', theme: 'success', iconName: 'notification', onDismiss: onClick, isOpen: true }));
				setTimeout(function () {
