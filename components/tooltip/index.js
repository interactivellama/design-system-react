define(['exports', 'react', 'prop-types', 'classnames', '../../utilities/constants', '../utilities/dialog', '../../utilities/dialog-helpers', './check-props', 'lodash.flatten', 'lodash.compact', 'shortid'], function (exports, _react, _propTypes, _classnames, _constants, _dialog, _dialogHelpers, _checkProps, _lodash, _lodash3, _shortid) {
	'use strict';
