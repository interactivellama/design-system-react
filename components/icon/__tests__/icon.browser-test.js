define(['react', 'create-react-class', 'prop-types', 'chai', 'chai-enzyme', '../../../tests/enzyme-helpers', '../../icon', '../../icon-settings'], function (_react, _createReactClass, _propTypes, _chai, _chaiEnzyme, _enzymeHelpers, _icon, _iconSettings) {
	'use strict';
