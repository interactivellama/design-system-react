define(['react', 'react-dom', 'prop-types', 'chai', 'chai-enzyme', 'enzyme', 'lodash.assign', 'react-addons-test-utils', '../../../tests/enzyme-helpers', '../../menu-dropdown', '../../icon-settings', '../../utilities/menu-list', '../../../utilities/key-code'], function (_react, _reactDom, _propTypes, _chai, _chaiEnzyme, _enzyme, _lodash, _reactAddonsTestUtils, _enzymeHelpers, _menuDropdown, _iconSettings, _menuList, _keyCode) {
	'use strict';
  ...
  */
	...
	var menuOptions = [{ label: 'A super short', value: 'A0' }, { label: 'B Option Super Super Long', value: 'B0' }, { label: 'C Option', value: 'C0' }, { disabled: true, label: 'D Option', value: 'D0' }];
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ id: 'custom-dropdown-menu-content-link', className: 'slds-m-right--medium', href: 'javascript:void(0);', onClick: props.onClick },
								'Settings'
							),
							_react2.default.createElement(
								'a',
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_extends({}, defaultProps, this.props),
						this.props.children
					)
				);
			}
	...
	describe('SLDSMenuDropdown', function () {
		...
		describe('Styling', function () {
			...
			it('has correct CSS classes and style', function () {
				var nodes = getNodes({ wrapper: this.wrapper });
				nodes.button.simulate('click', {});
				var openNodes = getNodes({ wrapper: this.wrapper });
		...
		describe('Custom Content Present', function () {
			beforeEach((0, _enzymeHelpers.mountComponent)(_react2.default.createElement(
				...
				_react2.default.createElement(DropdownCustomContent, null),
				_react2.default.createElement(_menuList2.default, { options: [{ label: 'Custom Content Option' }].concat(menuOptions) })
			)));
			...
			it('closes when custom content is clicked', function () {
				...
				var closedNodes = getNodes({ wrapper: this.wrapper });
			...
			it('has additional ListItem from list child\'s options prop', function () {
				...
				nodes.button.simulate('click', {});
				var openNodes = getNodes({ wrapper: this.wrapper });
				(0, _chai.expect)(openNodes.menu.find('#' + buttonId + '-item-0').text()).to.equal('Custom Content Option');
			});
		});
		...
		describe('Clickable', function () {
			...
			it('does not expand on hover', function () {
				...
				var hoverNodes = getNodes({ wrapper: this.wrapper });
		...
		describe('Hoverable', function () {
			...
			var renderDropdown = function renderDropdown(inst) {
				...
				return _reactDom2.default.render(_react2.default.createElement(
					...
					{ iconPath: '/assets/icons' },
					inst
				), body); // eslint-disable-line react/no-render-return-value
			};
		...
		describe('Hybrid-able', function () {
			...
			beforeEach(function () {
				cmp = dropItDown({ openOn: 'hybrid', onClick: onClick });
				btn = (0, _reactAddonsTestUtils.findRenderedDOMComponentWithClass)(cmp, 'slds-dropdown-trigger');
			});
