define(['react', 'enzyme', 'chai', 'chai-enzyme', '../../../tests/enzyme-helpers', '../../../utilities/sample-data/global-navigation-bar', '../../icon-settings', '../../global-navigation-bar', '../../global-navigation-bar/region', '../../global-navigation-bar/dropdown', '../../global-navigation-bar/link', '../../global-navigation-bar/label', '../../global-navigation-bar/button'], function (_react, _enzyme, _chai, _chaiEnzyme, _enzymeHelpers, _globalNavigationBar, _iconSettings, _globalNavigationBar2, _region, _dropdown, _link, _label, _button) {
	'use strict';
   ...
   */
		describe('Default Structure', function () {
			beforeEach((0, _enzymeHelpers.mountComponent)(_react2.default.createElement(
				_iconSettings2.default,
				{ iconPath: '/assets/icons' },
				_react2.default.createElement(
					_globalNavigationBar3.default,
					null,
			...
			it('has wrapping div and one primary region', function () {
				var component = this.wrapper.find('.' + COMPONENT_CSS_CLASSES.base);
				(0, _chai.expect)(component).to.have.length(1);

				var primary = this.wrapper.find('.' + REGION_CSS_CLASSES.primary);
		...
		describe('Optional Properties', function () {
			...
			it('has custom cloud and theme CSS', function () {
				var component = this.wrapper.find('.' + COMPONENT_CSS_CLASSES.base);
				(0, _chai.expect)(component.hasClass('' + COMPONENT_CSS_CLASSES.themePrefix + customCloudProps.cloud)).to.be.true;
				(0, _chai.expect)(component.hasClass('' + COMPONENT_CSS_CLASSES.themePrefix + customThemeProps.theme)).to.be.true;
			});
		});
		...
		describe('Optional Region Structure', function () {
			...
			beforeEach((0, _enzymeHelpers.mountComponent)(_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_region2.default,
						{ region: 'secondary', navigation: true, dividerPosition: 'right' },
			...
			it('has 1 primary, 1 secondary, and 1 tertiary region', function () {
				...
				var secondary = this.wrapper.find('.' + REGION_CSS_CLASSES.secondary);
				(0, _chai.expect)(secondary).to.have.length(1);

				var tertiary = this.wrapper.find('.' + REGION_CSS_CLASSES.tertiary);
			...
			it('Secondary region application is a nav HTML element and has divider on right side', function () {
				var nav = this.wrapper.find('.' + REGION_CSS_CLASSES.secondary);
		...
		describe('Secondary Region', function () {
			beforeEach((0, _enzymeHelpers.mountComponent)(_react2.default.createElement(
				_iconSettings2.default,
				{ iconPath: '/assets/icons' },
				_react2.default.createElement(_region2.default, { region: 'secondary' })
			)));
		...
		describe('GlobalNavigationLink child component', function () {
			...
			beforeEach(function () {
				...
				this.wrapper = (0, _enzyme.mount)(instance, { attachTo: document.body.appendChild(document.createElement('div')) });
