define(['react', 'react-dom', 'react-addons-test-utils', 'chai', 'lodash.assign', '../../button', '../../icon-settings'], function (_react, _reactDom, _reactAddonsTestUtils, _chai, _lodash, _button, _iconSettings) {
	'use strict';
