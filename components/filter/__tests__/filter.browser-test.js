define(['react', 'create-react-class', 'prop-types', 'chai', 'chai-enzyme', 'enzyme', '../../../tests/enzyme-helpers', '../../popover', '../../button', '../../filter', '../../icon-settings'], function (_react, _createReactClass, _propTypes, _chai, _chaiEnzyme, _enzyme, _enzymeHelpers, _popover, _button, _filter, _iconSettings) {
	'use strict';
