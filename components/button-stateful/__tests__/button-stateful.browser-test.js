define(['react', 'react-dom', 'lodash.assign', 'chai', '../../icon-settings', '../../icon', '../../button-stateful'], function (_react, _reactDom, _lodash, _chai, _iconSettings, _icon, _buttonStateful) {
	'use strict';
	...
	describe('Button Stateful: ', function () {
		...
		describe('External active props works', function () {
			var propsWithActive = (0, _lodash2.default)(requiredProps, { active: true });
