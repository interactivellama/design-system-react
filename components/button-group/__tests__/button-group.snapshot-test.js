define(['react', 'enzyme', 'enzyme-to-json', '../../../tests/snapshot-helpers', '../__examples__/icon-group', '../__examples__/more-icon', '../__examples__/checkbox', '../__examples__/checkbox-error'], function (_react, _enzyme, _enzymeToJson, _snapshotHelpers, _iconGroup, _moreIcon, _checkbox, _checkboxError) {
	'use strict';
